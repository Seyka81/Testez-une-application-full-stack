...
public class AuthControllerTest {
    ...
    void setUp() {
        ...
        user = new User("random@gmail.com", "gmail", "random", "password", false);
        user.setId(1L);
    ...
    void testLogIn() throws Exception {
        ...
        loginRequest.setEmail("random@gmail.com");
        loginRequest.setPassword("password");

        Mockito.when(authenticationManager.authenticate(Mockito.any())).thenReturn(authentication);
        SecurityContextHolder.getContext().setAuthentication(authentication);
        Mockito.when(jwtUtils.generateJwtToken(authentication)).thenReturn("mockJwtToken");
        Mockito.when(userRepository.findByEmail("random@gmail.com")).thenReturn(Optional.of(user));

        JwtResponse expectedResponse = new JwtResponse("mockJwtToken", 1L, "random@gmail.com", "random", "gmail",
                false);
    ...
    void testRegister() throws Exception {
        ...
        Mockito.when(userRepository.existsByEmail("random@gmail.com")).thenReturn(false);
    ...
    void testRegisterFail() throws Exception {
        ...
        Mockito.when(userRepository.existsByEmail("random@gmail.com")).thenReturn(true);
